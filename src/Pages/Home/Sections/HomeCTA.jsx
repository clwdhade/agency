    ...
    return (
        <div className='flex md:flex-row flex-col gap-4 mt-16 md:p-12 p-8 rounded bg-yellow-100'>
            ...
            <div className="w-full md:w-1/4 flex items-center flex-col justify-center">
                <button className="py-2 text-lg font-bold rounded bg-transparent border-2 border-yellow-500 hover:bg-yellow-700 hover:text-white w-3/4 transition-all md:hover:scale-110 ease-in-out flex flex-row justify-center gap-4 items-center">Get started! <BsBoxArrowUpRight className='text-base font-bold' /></button>
            </div>
        </div>
    )
}
